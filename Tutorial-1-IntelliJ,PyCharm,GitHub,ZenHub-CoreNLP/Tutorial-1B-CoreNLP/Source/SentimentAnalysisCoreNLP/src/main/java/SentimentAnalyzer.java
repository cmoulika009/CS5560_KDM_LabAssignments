...
public class SentimentAnalyzer {
    ...
    public SentimentfrmTextFile findSentiment(String line) {
        ...
        SentimentfrmTextFile SentimentfrmTextFile = new SentimentfrmTextFile(line, toCss(mainSentiment));
        return SentimentfrmTextFile;
    ...
    public static void main(String[] args) {
        ...
        SentimentfrmTextFile SentimentfrmTextFile = sentimentAnalyzer
