...
/**
 * Created by Moulika on 10-Jun-17.
 */
public class Main {
...
// Read text from file
        String text = readText("src/main/Data/BBCBlogger.txt");
...
//run annotation
        ...
        for (CoreMap sentence : sentences) {
            ...
            for (CoreLabel token : sentence.get(CoreAnnotations.TokensAnnotation.class)) {
                ...
                System.out.println("Text Annotation of "+token+" is " +word);
                //System.out.println(token + ":" + word);
                // this is the POS tag of the token

                String lemma = token.get(CoreAnnotations.LemmaAnnotation.class);
                System.out.println("Lemma Annotation "+token+" is " +lemma);
                //System.out.println(token + ":" + lemma);
                // this is the Lemmatized tag of the token


                String pos = token.get(CoreAnnotations.PartOfSpeechAnnotation.class);
                System.out.println("POS of "+token+" is " +pos);
                //System.out.println(token + ":" + pos);

                // this is the NER label of the token
                String ne = token.get(CoreAnnotations.NamedEntityTagAnnotation.class);
                System.out.println("NER of "+token+" is " +ne);
